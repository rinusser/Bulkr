...
namespace Bulkr.Gui.Components
{
	...
	///   </para>
	/// </summary>
	public abstract class CRUDComponent<MODEL> : Component where MODEL : Model, new()
	{
		...
		///   access it it via <see cref="Component.Context"/>.
		/// </remarks>
		...
		protected CRUDComponent(ComponentContext context) : base(context)
		{
